<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExamGroup.aspx.cs" Inherits="AttendanceExaminations_ExamGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Exam Group</h4>
                                         </div> 
                                     </div>
                              </div>
                  ...
                  <div class="col-md-5" style="background: #EFF3F8 none repeat scroll 0 0;"> 
                    <div class="space-4">
                                    ...
                                    <div class="space-4">
                                     ...
                                     <div class="row">
                                           <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlFeesType" ErrorMessage="Sorry! Exam Type Required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-md-7" >
                          <div class="row" >
                            ...
                            <asp:GridView ID="gvExamGroupInfoList" runat="server" AutoGenerateColumns="False"
                                AllowPaging="true" PageSize="5" AllowSorting="true" OnSorting="gvExamGroupInfoList_Sorting"
                                CssClass="gvv table table-striped table-hover" OnRowDeleting="gvExamGroupInfoList_RowDeleting"
                                OnPageIndexChanging="gvExamGroupInfoList_PageIndexChanging"
                                OnRowEditing="gvExamGroupInfoList_RowEditing" OnRowDataBound="gvExamGroupInfoList_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Exam Type">
                                        <ItemTemplate>
                                            <asp:Label ID="lblExamType" Visible="false" runat="server" Text='<%#Eval("ExamType")%>'></asp:Label>
                                            <asp:Label ID="lblExamTypeName" runat="server" Text='<%#Eval("ExamTypeName")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvExamGroupInfoList" EventName="RowDeleting" />
            <asp:AsyncPostBackTrigger ControlID="gvExamGroupInfoList" EventName="RowDataBound" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
