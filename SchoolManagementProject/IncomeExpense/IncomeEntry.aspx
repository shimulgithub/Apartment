<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IncomeEntry.aspx.cs" Inherits="IncomeExpense_IncomeEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Income Entry</h4>
                  ...
                  <div class="col-md-5" style="background: #EFF3F8 none repeat scroll 0 0;"> 
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtName"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="Label3" runat="server" Text="Income Date :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                                         <div class="input-group">
                                                <asp:TextBox ID="txtIncomeDate" placeholder="Income Date"   runat="server" CssClass="form-control date-picker"
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtName"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="Label2" runat="server" Text="Income Head Name :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="lblCode" runat="server" Text="Income Name :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                                          <asp:TextBox ID="txtName" runat="server" Text=""  placeholder="Income  Name"  CssClass="form-control"></asp:TextBox>
                                         </div>
                                     </div>
                                     <div class="space-4">
                                      </div>
                                  ...
                                  <div class="space-4">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtName"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="Label4" runat="server" Text="Income Amount(TK) :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                    ...
                    <div class="col-md-7" >
                          <div class="row" >
                            ...
                            <asp:GridView ID="gvIncome" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="10" AllowSorting="true"
                                CssClass="table table-striped table-hover"
                                OnSorting="gvIncome_Sorting" OnRowDeleting="gvIncome_RowDeleting"
                                OnRowEditing="gvIncome_RowEditing"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvIncome" EventName="RowDeleting" />
            <asp:AsyncPostBackTrigger ControlID="gvIncome" EventName="RowDataBound" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
