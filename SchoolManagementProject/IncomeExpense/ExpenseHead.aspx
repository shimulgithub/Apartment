<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExpenseHead.aspx.cs" Inherits="IncomeExpense_ExpenseHead" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Expense Head</h4>
                  ...
                  <div class="col-md-5" style="background: #EFF3F8 none repeat scroll 0 0;"> 
                    ...
                    <div class="col-md-7" >
                          <div class="row" >
                            ...
                            <asp:GridView ID="gvExpenseHead" runat="server" AutoGenerateColumns="False"
                                AllowPaging="true" PageSize="5" AllowSorting="true"
                                CssClass="gvv table table-striped table-hover"
                                OnRowDeleting="gvExpenseHead_RowDeleting"
                                OnRowEditing="gvExpenseHead_RowEditing" 
                                OnRowDataBound="gvExpenseHead_RowDataBound"
                                OnPageIndexChanging="gvExpenseHead_PageIndexChanging"
                                OnSorting="gvExpenseHead_Sorting"
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvExpenseHead" EventName="RowDeleting" />
            <asp:AsyncPostBackTrigger ControlID="gvExpenseHead" EventName="RowDataBound" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
