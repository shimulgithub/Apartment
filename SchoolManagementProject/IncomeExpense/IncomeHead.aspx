<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IncomeHead.aspx.cs" Inherits="IncomeExpense_IncomeHead" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Income Head</h4>
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="lblCode" runat="server" Text="Head Name :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                                          <asp:TextBox ID="txtName" runat="server" Text=""  placeholder="Head Name"  CssClass="form-control"></asp:TextBox>
                                         </div>
                                     </div>
                                     <div class="space-4">
                                      </div>
                          ...
                          <div class="row" >
                            ...
                            <asp:Label ID="Label7" runat="server" Text="" Font-Bold="True" Font-Size="Large"
                                ForeColor="#307ECC"></asp:Label></div>
                                          ...
                                          <asp:TextBox ID="txtSearchBox" runat="server" Width="100px" OnTextChanged="txtSearchBox_TextChanged"  Height="32px" AutoPostBack="true" Text=""  placeholder="Search..."  CssClass="form-control"></asp:TextBox>
                                         </div>
                                     </div>
                            <asp:GridView ID="gvIncomeHead" runat="server" AutoGenerateColumns="False"
                                AllowPaging="true" PageSize="5" AllowSorting="true"
                                CssClass="gvv table table-striped table-hover" OnRowDeleting="gvIncomeHead_RowDeleting"
                                OnRowEditing="gvIncomeHead_RowEditing"
                                 OnPageIndexChanging="gvIncomeHead_PageIndexChanging"
                                OnSorting="gvIncomeHead_Sorting"
                                OnRowDataBound="gvIncomeHead_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblFeesType" runat="server" Text='<%#Eval("HeadName")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvIncomeHead" EventName="RowDeleting" />
            <asp:AsyncPostBackTrigger ControlID="gvIncomeHead" EventName="RowDataBound" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
