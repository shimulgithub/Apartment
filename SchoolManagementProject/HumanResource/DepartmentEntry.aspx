<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DepartmentEntry.aspx.cs" Inherits="HumanResource_DepartmentEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Department</h4>
                  ...
                  <div class="col-md-5" style="background: #EFF3F8 none repeat scroll 0 0; height:346px; "> 
                    <br />
                      <div class="space-4">
                                    ...
                                    <div class="space-4">
                                     ...
                                     <div class="row">
                                           <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                            <asp:RequiredFieldValidator ID="rfvUserName" runat="server" ControlToValidate="txtDepartment" ErrorMessage="Sorry! Type Of Leave required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="Label1" runat="server" Text="Department :"></asp:Label>
                                           </div>
                                           <div class="col-md-8">
                                             <asp:TextBox ID="txtDepartment" runat="server"  placeholder="Department" CssClass="form-control" />
                                           </div>
                                      </div>
                                       <div class="space-4">
                                      </div>
                    ...
                    <div class="col-md-12" style="text-align: left;">
                        <div class="page-content" style="background: #EFF3F8 none repeat scroll 0 0;">
                            <asp:GridView ID="gvDepartmentList" runat="server" AutoGenerateColumns="False" 
                                AllowPaging="true"
                                PageSize="5"
                                CssClass="gvv table table-striped table-bordered table-hover"
                                OnRowDeleting="gvDepartmentList_RowDeleting"
                                OnRowEditing="gvDepartmentList_RowEditing" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Department">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTypeOfLeave" runat="server" Text='<%#Eval("Department")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvDepartmentList" EventName="RowDeleting" />
            <asp:AsyncPostBackTrigger ControlID="gvDepartmentList" EventName="RowDataBound" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
