...
public partial class FeesCollection_SearchFeesCollection : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["UserID"] != null)
        {
            if (!Page.IsPostBack)
            {
                ...
                Session["breadcrumb"] = "Accounts>Fees Search(Payment) ";
    ...
    private void LoadBindList()
    {
        try
        {
            ...
            dt = Global.CreateDataTableParameter_FeesSearchPayment(sql, ddlClass.SelectedValue, ddlSection.SelectedValue, ddlFeesType.SelectedValue);
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sql = "SP_TB_FeesSearchPaymentExportToExcel";
            string _SearchBox = "";
            if (txtSearchBox.Text == "")
            {
                _SearchBox = "0";
            ...
            dt2 = Global.CreateDataTableParameter_FeesSearchPayment(sql, ddlClass.SelectedValue, ddlSection.SelectedValue, ddlFeesType.SelectedValue, _SearchBox);
    ...
    private void LoadBindSearBoxList()
    {
        try
        {
            DataTable dt = new DataTable();

            string sql = "SP_TB_FeesSearchPaymentSearchBox";
            ...
            dt = Global.CreateDataTableParameter_FeesSearchPayment(sql, ddlClass.SelectedValue, ddlSection.SelectedValue, ddlFeesType.SelectedValue, _SearchBox);
            gvStudentWiseFeesCollectionDetail.DataSource = dt;
            Session["Dt"] = dt;
            int iTotalRecords = ((DataTable)(gvStudentWiseFeesCollectionDetail.DataSource)).Rows.Count;
            Session["iTotalRecords"] = iTotalRecords;
    ...
    protected void btnPaymentPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string param = "FeesPaymentSearch";
