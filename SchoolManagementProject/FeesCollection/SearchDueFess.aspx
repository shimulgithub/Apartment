<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SearchDueFess.aspx.cs" Inherits="FeesCollection_SearchDueFess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
              ...
              <div class="widget-header">
                    <div class="col-md-5">
                        <h4 class="widget-title">
                            <i class="icon-th"></i>&nbsp;Fees Search(Due)</h4>
                    </div>
                          ...
                          <div class="col-md-2">
                           <asp:DropDownList ID="ddlFeesType" runat="server" CssClass="select2">
                                 ...
                                 <div class="col-md-6">
                                   ...
                                   <asp:LinkButton ID="btnDuePrint" runat="server" OnClick="btnDuePrint_Click" CssClass="btn btn-primary btn-xs" ToolTip="Print File" Style="font-weight: bold; font-size: 14px; margin-left:5px; float:right;"><span class="icon-print icon-on-right bigger-110"></span>&nbsp;Print</asp:LinkButton>
        ...
        <Triggers>
          ...
          <asp:PostBackTrigger ControlID="btnDuePrint" />
