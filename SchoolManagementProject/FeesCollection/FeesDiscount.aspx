<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FeesDiscount.aspx.cs" Inherits="FeesCollection_FeesDiscount" %>
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Fees Discount</h4>
                  ...
                  <div class="col-md-5" style="background: #EFF3F8 none repeat scroll 0 0;"> 
                                    ...
                                    <div class="space-4">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="lblCode" runat="server" Text="Discount Name :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                                          <asp:TextBox ID="txtName" runat="server" Text=""  placeholder="Discount Name"  CssClass="form-control"></asp:TextBox>
                                         </div>
                                     </div>
                                     <div class="space-4">
                                      </div>
                                     ...
                                     <div class="row">
                                           <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                            ...
                                            <asp:Label ID="Label2" runat="server" Text="Discount Code :"></asp:Label>
                                           </div>
                                           <div class="col-md-8">
                                             <asp:TextBox ID="txtCode" runat="server"   placeholder="Discount Code" CssClass="form-control" />
                                           </div>
                                      </div>
                                      <div class="space-4">
                                      </div>
                                     <div class="row">
                                           <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCode" ErrorMessage="Sorry! Type Of Leave required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="Label3" runat="server" Text="Discount Amount :"></asp:Label>
                                           </div>
                                           <div class="col-md-8">
                                             <asp:TextBox ID="txtAmount" runat="server"   placeholder="Discount Amount" CssClass="form-control" />
                                           </div>
                                      </div>
                                  <div class="space-4">
                                      </div>
                    ...
                    <div class="col-md-7" >
                          <div class="row" >
                            ...
                            <asp:GridView ID="gvFeesReminderInfoList" runat="server" 
                                AutoGenerateColumns="False"
                                AllowPaging="true" AllowSorting="true" OnSorting="gvFeesReminderInfoList_Sorting"
                                OnPageIndexChanging="gvFeesReminderInfoList_PageIndexChanging"
                                CssClass="gvv table table-striped table-hover" OnRowDeleting="gvFeesReminderInfoList_RowDeleting"
                                OnRowEditing="gvFeesReminderInfoList_RowEditing" OnRowDataBound="gvFeesReminderInfoList_RowDataBound"
                            ...
                            <PagerStyle CssClass="pagination-ys" HorizontalAlign="Left" />
                                ...
                                <Columns>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="DisName" runat="server"  Text='<%# Bind("DisName") %>' ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Discount Code">
                                        <ItemTemplate>
                                            <asp:Label ID="DisCode" runat="server" Text='<%#Eval("DisCode")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Discount Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="DisAmount" runat="server" Text='<%#Eval("DisAmount")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
