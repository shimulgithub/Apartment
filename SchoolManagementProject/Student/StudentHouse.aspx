<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StudentHouse.aspx.cs" Inherits="Student_StudentHouse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Student House</h4>
          ...
          <%-------------------- Profile View-------------------%>
                 <div class="row" >
                  ...
                  <div class="col-md-5" style="background: #EFF3F8 none repeat scroll 0 0;"> 
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="lblCode" runat="server" Text="Name :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                                          <asp:TextBox ID="txtName" runat="server" Text=""  placeholder="Name"  CssClass="form-control"></asp:TextBox>
                                         </div>
                                     </div>
                                     <div class="space-4">
                                      </div>
                    ...
                    <div class="col-md-7" >
                          <div class="row" >
                            <asp:GridView ID="gvStudentHouseInfoList" runat="server" AutoGenerateColumns="False"
                                CssClass="gvv table table-striped table-hover" OnRowDeleting="gvStudentHouseInfoList_RowDeleting"
                                OnRowEditing="gvStudentHouseInfoList_RowEditing" OnRowDataBound="gvStudentHouseInfoList_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStudentHouse" runat="server" Text='<%#Eval("Name")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvStudentHouseInfoList" EventName="RowDeleting" />
            <asp:AsyncPostBackTrigger ControlID="gvStudentHouseInfoList" EventName="RowDataBound" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
