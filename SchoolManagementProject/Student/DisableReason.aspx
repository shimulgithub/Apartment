<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DisableReason.aspx.cs" Inherits="Student_DisableReason" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                             ...
                             <div class="widget-header">
                                    <div class="row">
                                         <div class="col-md-5">
                                          ...
                                          <i class="icon-th"></i>&nbsp;Disable Reason</h4>
          ...
          <%-------------------- Profile View-------------------%>
                 <div class="row" >
                  ...
                  <div class="col-md-5" style="background: #EFF3F8 none repeat scroll 0 0;"> 
                                    ...
                                    <div class="space-4">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4" style="font-weight: bold; text-align: right;">
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDisableReason"  ErrorMessage="Sorry! Code required" Text="*" ForeColor="Red" ValidationGroup="UserForm"></asp:RequiredFieldValidator>
                                            <asp:Label ID="lblCode" runat="server" Text="DisableReason :"></asp:Label>
                                          </div>
                                          <div class="col-md-8">
                                          <asp:TextBox ID="txtDisableReason" runat="server" Text=""  placeholder="DisableReason"  CssClass="form-control"></asp:TextBox>
                                         </div>
                                     </div>
                                     <div class="space-4">
                                      </div>
                    ...
                    <div class="col-md-7" >
                          <div class="row" >
                            <asp:GridView ID="gvDisableReasonInfoList" runat="server" AutoGenerateColumns="False"
                                CssClass="gvv table table-striped table-hover" OnRowDeleting="gvDisableReasonInfoList_RowDeleting"
                                OnRowEditing="gvDisableReasonInfoList_RowEditing" OnRowDataBound="gvDisableReasonInfoList_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Disable Reason">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDisableReason" runat="server" Text='<%#Eval("DisableReason")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="gvDisableReasonInfoList" EventName="RowDeleting" />
            <asp:AsyncPostBackTrigger ControlID="gvDisableReasonInfoList" EventName="RowDataBound" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
